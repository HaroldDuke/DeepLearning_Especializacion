...
RESULTADOS📊: En la primera configuración, el modelo aprendió más rápido durante las primeras épocas, ya que el error disminuyó rápidamente.
...
JUSTIFICACIÓN DE LAS TÉCNICAS UTILIZADAS Se eligió cambiar la tasa de aprendizaje porque es uno de los factores más importantes durante el entrenamiento de una red neuronal.
...
ANÁLISIS DE RESULTADOS🔍 Con base en las gráficas, se pudo observar que cuando la tasa de aprendizaje fue más alta, el modelo avanzó rápido al inicio, pero presentó algunos cambios bruscos.
...
IMPACTO Este tipo de pruebas permite entender cómo pequeños cambios en la configuración pueden mejorar significativamente el rendimiento del modelo.
